...
function AddNewFile({ pageTitle }) {
    ...
    return (
        // Start Add New File Page
        <div className="add-new-file d-flex flex-column align-items-center justify-content-center">
            <h1 className="bg-danger p-3 text-white mb-4">مرحباً بك في صفحة إضافة ملف جديد</h1>
